...
INSERT INTO `t_soldier` (`SOLDIER_ID`, `SOLDIER_NAME`, `SOLDIER_POINT`, `INPUT_DATE`, `UPDATE_DATE`, `ACTIVE_FLAG`) VALUES
  (1,'Ç¹¶Ü±ø',1,'8','2007-04-09 00:03:00','2007-04-08 00:00:00',0),
  (2,'³¤Ç¹±ø',1,'7','2007-04-09 00:03:00','2007-04-08 00:00:00',0),
  (3,'ÆïÇ¹±ø',1,'6','2007-04-09 00:03:01','2007-04-08 00:00:00',0),
  (4,'ÖØ¼×±ø',1,'6','2007-04-09 00:03:01','2007-04-08 00:00:00',0),
...
INSERT INTO `t_role` (`ROLE_ID`, `ROLE_NAME`, `INPUT_DATE`, `UPDATE_DATE`, `DELETED_FLAG`) VALUES
  (1,'ÏµÍ³¹ÜÀíÔ±','2008-07-17 22:43:56','2007-04-22 00:00:09',0),
  (2,'»áÔ±','2007-04-22 22:44:13','2007-04-23 00:00:00',0),
  (3,'ÓÎ¿Í','2007-04-22 22:44:29','2007-04-19 00:00:00',0),
  (4,'Î´ÖªÓÃ»§','2007-06-06 00:00:00','2007-06-06 00:00:00',0);
...
INSERT INTO `t_user` (`USER_ID`, `USER_NAME`, `USER_PASSWORD`, `USER_ROLE`, `USER_PHOTO`, `USER_EMAIL`, `USER_MSN`, `USER_SKYPE`, `ACCOUNT_NON_EXPIRED`, `ACCOUNT_NON_LOCKED`, `CREDENTIALS_NON_EXPIRED`, `INPUT_USER_ID`, `INPUT_DATETIME`, `UPDATE_USER_ID`, `UPDATE_DATETIME`, `DELETED_FLAG`, `USER_DESC`) VALUES
  (1,'Mary','1111',2,'DISPLAY_NAME1',NULL,NULL,NULL,NULL,0,1,1,1,'2007-09-10 01:27:02',NULL,'2006-01-02 00:00:00',0,NULL),
  (2,'Tom','2222',3,'DISPLAY_NAME2',NULL,NULL,NULL,NULL,1,1,1,2,'2007-05-17 21:10:50',NULL,'2006-02-02 00:00:00',0,NULL),
  (3,'MEI','3333',1,'DISPLAY_NAME3',NULL,NULL,NULL,NULL,1,1,1,3,'2008-05-18 22:18:27',NULL,'2006-01-02 00:00:00',0,NULL);
