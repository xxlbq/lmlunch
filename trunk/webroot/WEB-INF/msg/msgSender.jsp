      ...
      <tr>
        <td width="40%" height="238" align="center"><table width="229"  border="1" cellspacing="0" cellpadding="0">
          <tr>
			...
			<html:form action="jmsSend.do" method="post">
              ...
              <c:forEach var="iter" items="${dynamicForm.map.comments}">
			    <tr><td><c:out value="${iter.value.name}"/></td>
			        <td><c:out value="${iter.value.age}"/></td>             
			                     
			    </tr>        
			  </c:forEach>
			   
			  <c:forEach var="iter" items="${dynamicForm.map.people}">
			    <tr><td><c:out value="${iter}"/></td></tr>        
			  </c:forEach>
