      ...
      <tr>
        <td width="40%" height="238" align="center"><table width="229"  border="1" cellspacing="0" cellpadding="0">
          <tr>
			...
			<html:form action="jmsTopicReceive.do" method="post">
              <table width="95%" height="153" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr><td><p>接收Topic消息</td></tr>
                <tr>
                  <td width="72%">消息:
                  <logic:present name="receiveText">
                  <input type="text" name="receivemsg" style="border-style: solid; border-width: 1" size="15" value="<bean:write name="receiveText"/>"/></td>
                  </logic:present>
               
                  	<logic:notPresent name="receiveText">
                  <input type="text" name="receivemsg" style="border-style: solid; border-width: 1" size="15" /></td>
                  </logic:notPresent>
              ...
              <tr>
                <td>
                  <div align="center"><html:submit style="width=60;" value="接收" /></div></td>
              </tr>
            </table>
            </html:form>
            </td>
